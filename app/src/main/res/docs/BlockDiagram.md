...
%% ViewModel to Data/Auth Dependencies (Reversed: Dependency --> Dependent)
...
%% MainActivity and Navigation (Reversed: Dependency --> Dependent)
...
%% Class Definitions with explicit text color
